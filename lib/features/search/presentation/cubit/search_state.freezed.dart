...
return loaded(_that.games);case SearchError() when error != null:
...
return loaded(_that.games);case SearchError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class SearchLoaded implements SearchState {
  const SearchLoaded(final  List<Game> games): _games = games;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchLoaded&&const DeepCollectionEquality().equals(other._games, _games));
}
...
@override
String toString() {
  return 'SearchState.loaded(games: $games)';
}
